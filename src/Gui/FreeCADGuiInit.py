                        ...
                        if ran_init:
                            ...
                            if classname:
                                try:
                                    ...
                                    Log(
                                        f"Failed to get handle to {classname} -- no icon can be generated, check classname in package.xml\n"
                                    )
                                else:
                                    GeneratePackageIcon(
...
def GeneratePackageIcon(
    ...
    if hasattr(wb_handle, "Icon") and wb_handle.Icon:
        Log(
            f"Init:      Packaged workbench {workbench_metadata.Name} specified icon in class {workbench_metadata.Classname}"
        )
