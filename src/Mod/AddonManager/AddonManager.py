...
class CommandAddonManager:
    ...
    def no_pip(self, command: str, repo: Addon) -> None:
        ...
        result = QtWidgets.QMessageBox.critical(
            ...
            + f"\n\n{command}\n\n"
            + translate(
                "AddonsInstaller", "Continue with installation of {} anyway?"
            ).format(repo.name),
            QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No,
        )
        if result == QtWidgets.QMessageBox.Yes:
    ...
    def on_update_all_completed(self) -> None:
        ...
        if not self.subupdates_failed:
            message = translate(
                "AddonsInstaller", "All packages were successfully updated: \n"
            )
            ...
            message = (
                translate("AddonsInstaller", "Some packages updates failed.")
                + "\n\n"
