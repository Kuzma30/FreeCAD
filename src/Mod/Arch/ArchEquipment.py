...
def createMeshView(
    obj, direction=FreeCAD.Vector(0, 0, -1), outeronly=False, largestonly=False
):
    ...
    def Activated(self):
        ...
        if not s:
            FreeCAD.Console.PrintError(
                translate(
                    "Arch",
                    "You must select a base shape object and optionally a mesh object",
                )
            )
        else:
            base = ""
            ...
            FreeCAD.ActiveDocument.openTransaction(
                str(translate("Arch", "Create Equipment"))
            )
        ...
        if len(s) != 1:
            ...
            if not obj.isDerivedFrom("Mesh::Feature"):
                ...
                if obj.Mesh.CountFacets > 1000:
                    ...
                    msgBox.setText(
                        translate("Arch", "This mesh has more than 1000 facets.")
                    )
                    msgBox.setInformativeText(
                        translate(
                            "Arch", "This operation can take a long time. Proceed?"
                        )
                    )
    ...
    def setProperties(self, obj):
        ...
        if not "Model" in pl:
            obj.addProperty(
                ...
                "Equipment",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The model description of this equipment"
                ),
            )
        if not "ProductURL" in pl:
            obj.addProperty(
                ...
                "Equipment",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The URL of the product page of this equipment"
                ),
            )
        ...
        if not "SnapPoints" in pl:
            obj.addProperty(
                ...
                "Equipment",
                QT_TRANSLATE_NOOP(
                    "App::Property", "Additional snap points for this equipment"
                ),
            )
        if not "EquipmentPower" in pl:
            obj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "The electric power needed by this equipment in Watts",
                ),
            )
