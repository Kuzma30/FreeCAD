    ...
    def setProperties(self, obj):
        ...
        if not "Profile" in pl:
            obj.addProperty(
                ...
                "Frame",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The profile used to build this frame"
                ),
            )
        if not "Align" in pl:
            obj.addProperty(
        ...
        if not "Offset" in pl:
            obj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "An offset vector between the base sketch and the frame",
                ),
            )
        if not "BasePoint" in pl:
            obj.addProperty(
                ...
                "Frame",
                QT_TRANSLATE_NOOP(
                    "App::Property", "Crossing point of the path on the profile."
                ),
            )
