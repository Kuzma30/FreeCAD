    ...
    def setProperties(self, obj):
        ...
        if not "Chamfer" in pl:
            obj.addProperty(
                ...
                "Beam",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The size of the chamfer of this element"
                ),
            )
    ...
    def setProperties(self, obj):
        ...
        if not "Chamfer" in pl:
            obj.addProperty(
                ...
                "Beam",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The chamfer length of this element"
                ),
            )
    ...
    def setProperties(self, obj):
        ...
        if not "GrooveNumber" in pl:
            obj.addProperty(
                ...
                "Column",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The number of grooves of this element"
                ),
            )
        if not "Dents" in pl:
            obj.addProperty(
...
class _PrecastSlab(_Precast):
    ...
    def setProperties(self, obj):
        ...
        if not "SlabBase" in pl:
            obj.addProperty(
                ...
                "Slab",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The size of the base of this element"
                ),
            )
        if not "HoleNumber" in pl:
            obj.addProperty(
                ...
                "Slab",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The number of holes in this element"
                ),
            )
        if not "HoleMajor" in pl:
            obj.addProperty(
                ...
                "Slab",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The major radius of the holes of this element"
                ),
            )
        if not "HoleMinor" in pl:
            obj.addProperty(
                ...
                "Slab",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The minor radius of the holes of this element"
                ),
            )
        if not "HoleSpacing" in pl:
            obj.addProperty(
                ...
                "Slab",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The spacing between the holes of this element"
                ),
            )
    ...
    def execute(self, obj):
        ...
        if height < (base * 2):
            return
        if (holenumber > 0) and (
            (holespacing == 0) or (holemajor == 0) or (holeminor == 0)
        ):
            return
        ...
        if holenumber > 0:
            ...
            if holeminor != holemajor:
                e = Part.Ellipse(
                    Vector(0, 0, 0),
                    Vector(0, holeminor / 2, 0),
                    Vector(0, 0, holemajor / 2),
                ).toShape()
                e.translate(Vector(0, 0, -holemajor / 2))
            else:
                e = Part.Circle(
                    Vector(0, 0, 0), Vector(1, 0, 0), holemajor / 2
                ).toShape()
            w = Part.Wire([e])
            f = Part.Face(w)
    ...
    def setProperties(self, obj):
        ...
        if not "DownLength" in pl:
            obj.addProperty(
                ...
                "Stairs",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The length of the down floor of this element"
                ),
            )
        if not "RiserNumber" in pl:
            obj.addProperty(
                ...
                "Stairs",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The number of risers in this element"
                ),
            )
        if not "Riser" in pl:
            obj.addProperty(
...
class _PrecastTaskPanel:
    ...
    def __init__(self):
        ...
        QtCore.QObject.connect(
            self.valueDentHeight,
            QtCore.SIGNAL("valueChanged(double)"),
            self.setDentHeight,
        )
        QtCore.QObject.connect(
            self.valueBase, QtCore.SIGNAL("valueChanged(double)"), self.setBase
        )
        QtCore.QObject.connect(
            self.valueHoleMajor,
            QtCore.SIGNAL("valueChanged(double)"),
        ...
        QtCore.QObject.connect(
            self.valueHoleSpacing,
            QtCore.SIGNAL("valueChanged(double)"),
            self.setHoleSpacing,
        )
        QtCore.QObject.connect(
            self.valueGrooveDepth,
            QtCore.SIGNAL("valueChanged(double)"),
            self.setGrooveDepth,
        )
        QtCore.QObject.connect(
            self.valueGrooveHeight,
            QtCore.SIGNAL("valueChanged(double)"),
            self.setGrooveHeight,
        )
        QtCore.QObject.connect(
            self.valueGrooveSpacing,
            QtCore.SIGNAL("valueChanged(double)"),
            self.setGrooveSpacing,
        )
        QtCore.QObject.connect(
            self.valueDownLength,
            QtCore.SIGNAL("valueChanged(double)"),
            self.setDownLength,
        )
        QtCore.QObject.connect(
        ...
        self.valueGrooveSpacing.setText(
            str(param.GetFloat("PrecastGrooveSpacing", 0.0))
        )
...
class _DentsTaskPanel:
    ...
    def __init__(self):
        ...
        QtCore.QObject.connect(
            self.buttonRemove, QtCore.SIGNAL("clicked()"), self.removeDent
        )
        QtCore.QObject.connect(
            self.listDents,
