...
class _Space(ArchComponent.Component):
    ...
    def setProperties(self, obj):
        ...
        if not "Area" in pl:
            obj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The computed floor area of this space"
                ),
            )
        if not "FinishFloor" in pl:
            obj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The finishing of the floor of this space"
                ),
            )
        if not "FinishWalls" in pl:
            obj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The finishing of the walls of this space"
                ),
            )
        if not "FinishCeiling" in pl:
            obj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The finishing of the ceiling of this space"
                ),
            )
        if not "Group" in pl:
            obj.addProperty(
        ...
        if not "Conditioning" in pl:
            obj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The type of air conditioning of this space"
                ),
            )
    ...
    def getFootprint(self, obj):
        ...
        try:
            ...
            w = Part.Wire(e)
            dv = FreeCAD.Vector(
                obj.Shape.CenterOfMass.x,
                obj.Shape.CenterOfMass.y,
...
class _ViewProviderSpace(ArchComponent.ViewProviderComponent):
    ...
    def __init__(self, vobj):
        ...
        vobj.DrawStyle = ["Solid", "Dashed", "Dotted", "Dashdot"][
            prefs.GetInt("defaultSpaceStyle", 2)
        ]
    ...
    def setProperties(self, vobj):
        ...
        if not "FirstLine" in pl:
            vobj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The size of the first line of text"
                ),
            )
        ...
        if not "LineSpacing" in pl:
            vobj.addProperty(
                ...
                "Space",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The space between the lines of text"
                ),
            )
    ...
    def onChanged(self, vobj, prop):
        ...
        if prop in ["Text", "Decimals", "ShowUnit"]:
            if (
                hasattr(self, "text1")
                and hasattr(self, "text2")
                and hasattr(vobj, "Text")
            ):
            ...
            if hasattr(vobj, "ShapeColor"):
                self.fmat.diffuseColor.setValue(
                    (vobj.ShapeColor[0], vobj.ShapeColor[1], vobj.ShapeColor[2])
                )
...
class SpaceTaskPanel(ArchComponent.ComponentTaskPanel):
    ...
    def __init__(self):
        ...
        self.editButton.setText(
            QtGui.QApplication.translate("Arch", "Set text position", None)
        )
        QtCore.QObject.connect(
            self.editButton, QtCore.SIGNAL("clicked()"), self.setTextPos
        )
        boundLabel = QtGui.QLabel(self.form)
        self.grid.addWidget(boundLabel, 5, 0, 1, 2)
        boundLabel.setText(
            QtGui.QApplication.translate("Arch", "Space boundaries", None)
        )
        ...
        QtCore.QObject.connect(
            self.addCompButton, QtCore.SIGNAL("clicked()"), self.addBoundary
        )
        ...
        QtCore.QObject.connect(
            self.delCompButton, QtCore.SIGNAL("clicked()"), self.delBoundary
        )
    ...
    def addBoundary(self):
        ...
        if self.obj:
            if FreeCADGui.Selection.getSelectionEx():
                self.obj.Proxy.addSubobjects(
                    self.obj, FreeCADGui.Selection.getSelectionEx()
                )
