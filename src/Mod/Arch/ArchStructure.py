    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                ...
                "Create multiple Arch Structure objects from a selected base, using each selected edge as an extrusion path",
            ),
        }
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                ...
                "Create a structural system object from a selected structure and axis",
            ),
        }
