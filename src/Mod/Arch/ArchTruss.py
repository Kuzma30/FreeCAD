    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Arch_Truss",
                "Creates a truss object from selected line or from scratch",
            ),
        }
    ...
    def Activated(self):
        ...
        if len(sel) > 1:
            ...
            FreeCADGui.doCommand(
                "obj = Arch.makeTruss(FreeCAD.ActiveDocument."
...
class Truss(ArchComponent.Component):
    ...
    def setProperties(self, obj):
        ...
        if not "Normal" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The normal direction of this truss"
                ),
            )
        ...
        if not "HeightStart" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The height of the truss at the start position"
                ),
            )
            obj.HeightStart = 100
        if not "HeightEnd" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The height of the truss at the end position"
                ),
            )
            obj.HeightEnd = 200
        if not "StrutStartOffset" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "An optional start offset for the top strut"
                ),
            )
        if not "StrutEndOffset" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "An optional end offset for the top strut"
                ),
            )
        if not "StrutHeight" in pl:
            obj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "The height of the main top and bottom elements of the truss",
                ),
            )
            obj.StrutHeight = 10
        if not "StrutWidth" in pl:
            obj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "The width of the main top and bottom elements of the truss",
                ),
            )
            obj.StrutWidth = 5
        if not "RodType" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The type of the middle element of the truss"
                ),
            )
        ...
        if not "RodEnd" in pl:
            obj.addProperty(
                ...
                "Truss",
                QT_TRANSLATE_NOOP(
                    "App::Property", "If the truss has a rod at its endpoint or not"
                ),
            )
    ...
    def makeTruss(self, obj, v0, v1):
        ...
        sidedir.normalize()
        p0 = v0.add(
            FreeCAD.Vector(sidedir).negative().multiply(obj.StrutWidth.Value / 2)
        )
        p1 = p0.add(
            FreeCAD.Vector(sidedir).multiply(obj.StrutWidth.Value / 2).multiply(2)
        )
        ...
        toprodstart = v2.add(
            FreeCAD.Vector(normal).multiply(obj.StrutHeight.Value / 2).negative()
        )
        ...
        if obj.RodMode == rodmodes[0]:
            ...
            for i in range(1, obj.RodSections + 1):
                ...
                if obj.RodDirection == "Forward":
                    rods.append(
                        self.makeRod(rodprofile, bottomrodpos[-2], toprodpos[-1])
                    )
                else:
                    rods.append(
                        self.makeRod(rodprofile, bottomrodpos[-1], toprodpos[-2])
                    )
