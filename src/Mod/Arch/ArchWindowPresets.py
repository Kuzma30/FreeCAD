...
def makeWindowPreset(
    windowtype, width, height, h1, h2, h3, w1, w2, o1, o2, placement=None
):
    ...
    def makeSketch(windowtype, width, height, h1, h2, h3, w1, w2, o1, o2):
        ...
        if windowtype == "Fixed":
            ...
            wp.extend(
                ["Glass", "Glass panel", "Wire1", str(w1 / gla), str(w1 / 2) + "+V"]
            )
            ...
            if w2 == w1:
                fw = "0.00+V"
            wp.extend(
                ["InnerFrame", "Frame", "Wire2,Wire3,Edge8,Mode1", fw, str(o2) + "+V"]
            )
            wp.extend(
                [
                    "InnerGlass",
            ...
            if w2 == w1:
                fw = "0.00+V"
            wp.extend(
                ["LeftFrame", "Frame", "Wire2,Wire3,Edge8,Mode1", fw, str(o2) + "+V"]
            )
            wp.extend(
                [
                    "LeftGlass",
            ...
            wp.extend(
                ["RightFrame", "Frame", "Wire4,Wire5,Edge6,Mode2", fw, str(o2) + "+V"]
            )
            wp.extend(
                [
                    "RightGlass",
            ...
            if w2 == w1:
                fw = "0.00+V"
            wp.extend(
                ["InnerFrame", "Frame", "Wire2,Wire3,Edge7,Mode1", fw, str(o2) + "+V"]
            )
            wp.extend(
                [
                    "InnerGlass",
            ...
            wp.extend(
                ["Door", "Solid panel", "Wire1,Edge8,Mode2", str(w2), str(o2) + "+V"]
            )
    ...
    if windowtype in WindowPresets:
        ...
        if default:
            ...
            obj.Placement = (
                FreeCAD.Placement()
            )  # unable to find where this bug comes from...
