...
class ArchWorkbench(FreeCADGui.Workbench):
    ...
    def __init__(self):
        ...
        _tooltip = (
            "The Arch workbench is used to model "
            "architectural components, and entire buildings"
        )
        self.__class__.Icon = os.path.join(
            __dirname__, "Resources", "icons", "ArchWorkbench.svg"
        )
    ...
    def Initialize(self):
        ...
        self.archtools = [
            ...
            (
                ...
                list(stru_group.GetCommands(stru_group)),
            ),  # tuple len=2: submenu
        ...
        try:
            ...
            class RebarGroupCommand:
                ...
                def GetResources(self):
                    return {
                        "MenuText": QT_TRANSLATE_NOOP("Arch_RebarTools", "Rebar tools"),
        ...
        # Set up toolbars
        it.init_toolbar(
            self, QT_TRANSLATE_NOOP("Workbench", "Arch tools"), self.archtools
        )
        it.init_toolbar(
            self,
        ...
        it.init_menu(self, [QT_TRANSLATE_NOOP("Workbench", "&Arch")], self.archtools)
        it.init_menu(
            self,
            [
        ...
        if hasattr(FreeCADGui, "draftToolBar"):
            if not hasattr(FreeCADGui.draftToolBar, "loadedArchPreferences"):
                FreeCADGui.addPreferencePage(
                    ":/ui/preferences-arch.ui", QT_TRANSLATE_NOOP("Arch", "Arch")
                )
                FreeCADGui.addPreferencePage(
...
FreeCADGui.addPreferencePage(
    ":/ui/preferences-ifc.ui", QT_TRANSLATE_NOOP("Draft", "Import-Export")
)
FreeCADGui.addPreferencePage(
    ":/ui/preferences-ifc-export.ui", QT_TRANSLATE_NOOP("Draft", "Import-Export")
)
FreeCADGui.addPreferencePage(
    ":/ui/preferences-dae.ui", QT_TRANSLATE_NOOP("Draft", "Import-Export")
)
