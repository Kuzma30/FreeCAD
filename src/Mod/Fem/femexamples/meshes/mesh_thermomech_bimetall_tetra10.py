...
def create_elements(femmesh):
    ...
    femmesh.addVolume(
        [1032, 1302, 1053, 1052, 2660, 2659, 1261, 1183, 2668, 1068], 2144
    )
    ...
    femmesh.addVolume(
        [1302, 1052, 1032, 1301, 2668, 1183, 2660, 1317, 2662, 2667], 2147
    )
    ...
    femmesh.addVolume(
        [1262, 1054, 1303, 1300, 2663, 2664, 1435, 1320, 2673, 1316], 2152
    )
    ...
    femmesh.addVolume(
        [1262, 1051, 1054, 1300, 2675, 1067, 2663, 1320, 2661, 2673], 2165
    )
    femmesh.addVolume([1301, 67, 146, 536, 2666, 772, 1312, 2410, 581, 582], 2166)
    femmesh.addVolume(
        [1032, 1281, 1302, 1301, 2431, 1510, 2660, 2667, 1432, 1317], 2167
    )
    ...
    femmesh.addVolume(
        [1051, 1054, 1013, 1262, 1067, 1186, 1071, 2675, 2663, 2433], 2175
    )
    ...
    femmesh.addVolume(
        [1300, 2049, 1533, 1511, 3078, 2841, 2842, 2686, 2685, 2845], 2881
    )
    femmesh.addVolume([1811, 2030, 472, 1281, 2832, 2258, 2010, 2831, 2848, 3036], 2882)
    femmesh.addVolume(
        [1522, 2050, 1534, 1301, 2681, 2828, 2846, 2682, 3079, 2827], 2883
    )
    femmesh.addVolume([1262, 266, 2052, 1303, 1433, 3081, 3080, 1435, 1309, 3082], 2884)
    femmesh.addVolume(
        [1772, 1303, 1512, 2052, 2687, 2679, 2852, 2688, 3082, 2680], 2885
    )
    femmesh.addVolume(
        [2051, 1523, 1773, 1302, 2677, 3037, 2683, 3077, 2678, 2684], 2886
    )
    ...
    femmesh.addVolume(
        [2050, 2051, 2030, 1302, 2066, 2259, 2181, 3085, 3077, 3076], 2894
    )
    ...
    femmesh.addVolume(
        [2050, 1302, 1281, 1301, 3085, 1510, 3084, 3079, 1317, 1432], 2897
    )
    ...
    femmesh.addVolume(
        [1303, 2052, 1262, 1300, 3082, 3080, 1435, 1316, 3090, 1320], 2902
    )
    ...
    femmesh.addVolume(
        [1262, 2052, 2049, 1300, 3080, 2065, 3092, 1320, 3090, 3078], 2915
    )
    femmesh.addVolume([393, 146, 1534, 2050, 1770, 1578, 1580, 2061, 3083, 2828], 2916)
    femmesh.addVolume(
        [2030, 1281, 2050, 1302, 2848, 3084, 2181, 3076, 1510, 3085], 2917
    )
    ...
    femmesh.addVolume(
        [2049, 2052, 1262, 2011, 2065, 3080, 3092, 2069, 2184, 2850], 2925
    )
