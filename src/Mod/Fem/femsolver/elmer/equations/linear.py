...
class Proxy(equation.Proxy):
    def __init__(self, obj):
        ...
        obj.addProperty(
            "App::PropertyEnumeration", "LinearSolverType", "Linear System", ""
        )
        obj.LinearSolverType = LINEAR_SOLVER
        obj.LinearSolverType = "Iterative"
        obj.addProperty(
            "App::PropertyEnumeration", "LinearDirectMethod", "Linear System", ""
        )
        ...
        obj.addProperty("App::PropertyInteger", "BiCGstablDegree", "Linear System", "")
        obj.addProperty(
        ...
        obj.addProperty("App::PropertyFloat", "LinearTolerance", "Linear System", "")
        obj.LinearTolerance = 1e-8
        obj.addProperty("App::PropertyInteger", "LinearIterations", "Linear System", "")
        obj.LinearIterations = 500
        obj.addProperty(
            "App::PropertyFloat", "SteadyStateTolerance", "Steady State", ""
        )
        obj.SteadyStateTolerance = 1e-5
        obj.addProperty("App::PropertyBool", "Stabilize", "Base", "")
        obj.Stabilize = True
        obj.addProperty("App::PropertyBool", "Bubbles", "Base", "")
        obj.Bubbles = False
