...
class TestMeshCommon(unittest.TestCase):
    ...
    def test_unv_save_load(self):
        ...
        unv_file = join(
            testtools.get_fem_test_tmp_dir("mesh_common_unv_save"), "tetra10_mesh.unv"
        )
    ...
    def test_writeAbaqus_precision(self):
        ...
        inp_file = join(
            testtools.get_fem_test_tmp_dir("mesh_common_inp_preci"), "seg2_mesh.inp"
        )
...
class TestMeshEleTetra10(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_testfile = join(
            testtools.get_fem_test_home_dir(), "mesh", (self.elem + "_mesh.")
        )
    ...
    def get_file_paths(self, file_extension):
        ...
        outfile = join(
            testtools.get_fem_test_tmp_dir(
                "mesh_elements_" + self.elem + "_" + file_extension
            ),
...
class TestMeshGroups(unittest.TestCase):
    ...
    def test_delete_groups(self):
        ...
        self.assertEqual(
            ...
            new_group_count,
            msg=(
                "GroupCount before and after adding and deleting groups differ: {0} != {1}".format(
    ...
    def test_add_group_elements(self):
        ...
        self.assertEqual(
            ...
            elements_returned,
            msg=(
                "elements to be added {0} and elements returned {1} differ".format(
