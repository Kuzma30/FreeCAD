...
class TestObjectCreate(unittest.TestCase):
    ...
    def test_femobjects_make(self):
        ...
        fcc_print("Save FreeCAD all objects file to {} ...".format(save_fc_file))
...
class TestObjectType(unittest.TestCase):
    ...
    def test_femobjects_type(self):
        ...
        self.assertEqual(
            "Fem::ConstraintFixed", type_of_obj(ObjectsFem.makeConstraintFixed(doc))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "Fem::ConstraintSpring", type_of_obj(ObjectsFem.makeConstraintSpring(doc))
        )
        self.assertEqual(
            "Fem::ConstraintForce", type_of_obj(ObjectsFem.makeConstraintForce(doc))
        )
        self.assertEqual(
            "Fem::ConstraintGear", type_of_obj(ObjectsFem.makeConstraintGear(doc))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "Fem::ConstraintPulley", type_of_obj(ObjectsFem.makeConstraintPulley(doc))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "Fem::ConstraintTie", type_of_obj(ObjectsFem.makeConstraintTie(doc))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "Fem::ElementFluid1D", type_of_obj(ObjectsFem.makeElementFluid1D(doc))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "Fem::MaterialCommon", type_of_obj(ObjectsFem.makeMaterialFluid(doc))
        )
        ...
        self.assertEqual(
            "Fem::MeshGroup", type_of_obj(ObjectsFem.makeMeshGroup(doc, mesh))
        )
        self.assertEqual(
            "Fem::MeshRegion", type_of_obj(ObjectsFem.makeMeshRegion(doc, mesh))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "Fem::ResultMechanical", type_of_obj(ObjectsFem.makeResultMechanical(doc))
        )
        ...
        self.assertEqual(
            "Fem::SolverCalculix", type_of_obj(ObjectsFem.makeSolverCalculix(doc))
        )
        self.assertEqual("Fem::SolverElmer", type_of_obj(solverelmer))
        self.assertEqual(
            "Fem::SolverMystran", type_of_obj(ObjectsFem.makeSolverMystran(doc))
        )
    ...
    def test_femobjects_isoftype(self):
        ...
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintBearing(doc), "Fem::ConstraintBearing")
        )
        self.assertTrue(
            is_of_type(
        ...
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintContact(doc), "Fem::ConstraintContact")
        )
        self.assertTrue(
            is_of_type(
        ...
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintFixed(doc), "Fem::ConstraintFixed")
        )
        self.assertTrue(
            is_of_type(
        ...
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintSpring(doc), "Fem::ConstraintSpring")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintForce(doc), "Fem::ConstraintForce")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintGear(doc), "Fem::ConstraintGear")
        )
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeConstraintHeatflux(doc), "Fem::ConstraintHeatflux"
            )
        )
        self.assertTrue(
            is_of_type(
        ...
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeConstraintPressure(doc), "Fem::ConstraintPressure"
            )
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintPulley(doc), "Fem::ConstraintPulley")
        )
        self.assertTrue(
            is_of_type(
        ...
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeConstraintSelfWeight(doc), "Fem::ConstraintSelfWeight"
            )
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintCentrif(doc), "Fem::ConstraintCentrif")
        )
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeConstraintTemperature(doc), "Fem::ConstraintTemperature"
            )
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeConstraintTie(doc), "Fem::ConstraintTie")
        )
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeConstraintTransform(doc), "Fem::ConstraintTransform"
            )
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeElementFluid1D(doc), "Fem::ElementFluid1D")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeElementGeometry1D(doc), "Fem::ElementGeometry1D")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeElementGeometry2D(doc), "Fem::ElementGeometry2D")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeElementRotation1D(doc), "Fem::ElementRotation1D")
        )
        materialsolid = ObjectsFem.makeMaterialSolid(doc)
        self.assertTrue(
            is_of_type(ObjectsFem.makeMaterialFluid(doc), "Fem::MaterialCommon")
        )
        ...
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeMaterialReinforced(doc), "Fem::MaterialReinforced"
            )
        )
        mesh = ObjectsFem.makeMeshGmsh(doc)
        ...
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeMeshBoundaryLayer(doc, mesh), "Fem::MeshBoundaryLayer"
            )
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeMeshGroup(doc, mesh), "Fem::MeshGroup")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeMeshRegion(doc, mesh), "Fem::MeshRegion")
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeMeshNetgen(doc), "Fem::FemMeshShapeNetgenObject")
        )
        self.assertTrue(is_of_type(ObjectsFem.makeMeshResult(doc), "Fem::MeshResult"))
        self.assertTrue(
            is_of_type(ObjectsFem.makeResultMechanical(doc), "Fem::ResultMechanical")
        )
        solverelmer = ObjectsFem.makeSolverElmer(doc)
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeSolverCalculixCcxTools(doc), "Fem::SolverCcxTools"
            )
        )
        self.assertTrue(
            is_of_type(ObjectsFem.makeSolverCalculix(doc), "Fem::SolverCalculix")
        )
        self.assertTrue(is_of_type(solverelmer, "Fem::SolverElmer"))
        self.assertTrue(
            is_of_type(ObjectsFem.makeSolverMystran(doc), "Fem::SolverMystran")
        )
        ...
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeEquationFlow(doc, solverelmer), "Fem::EquationElmerFlow"
            )
        )
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeEquationFlux(doc, solverelmer), "Fem::EquationElmerFlux"
            )
        )
        self.assertTrue(
            is_of_type(
                ObjectsFem.makeEquationHeat(doc, solverelmer), "Fem::EquationElmerHeat"
            )
        )
    ...
    def test_femobjects_derivedfromfem(self):
        ...
        self.assertTrue(
            is_derived_from(constant_vacuumpermittivity, "App::DocumentObject")
        )
        self.assertTrue(
            is_derived_from(constant_vacuumpermittivity, "Fem::ConstraintPython")
        )
        self.assertTrue(
            is_derived_from(
                constant_vacuumpermittivity, "Fem::ConstantVacuumPermittivity"
            )
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_body_heat_source, "App::DocumentObject")
        )
        self.assertTrue(
            is_derived_from(constraint_body_heat_source, "Fem::ConstraintPython")
        )
        self.assertTrue(
            is_derived_from(
                constraint_body_heat_source, "Fem::ConstraintBodyHeatSource"
            )
        )
        ...
        self.assertTrue(is_derived_from(constraint_dicplacement, "App::DocumentObject"))
        self.assertTrue(is_derived_from(constraint_dicplacement, "Fem::Constraint"))
        self.assertTrue(
            is_derived_from(constraint_dicplacement, "Fem::ConstraintDisplacement")
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_electorstatic_potential, "App::DocumentObject")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            is_derived_from(constraint_flow_velocity, "Fem::ConstraintFlowVelocity")
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_fluid_boundary, "Fem::ConstraintFluidBoundary")
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_initial_flow_velocity, "App::DocumentObject")
        )
        self.assertTrue(
            is_derived_from(constraint_initial_flow_velocity, "Fem::ConstraintPython")
        )
        self.assertTrue(
            is_derived_from(
                constraint_initial_flow_velocity, "Fem::ConstraintInitialFlowVelocity"
            )
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_initial_temperature, "App::DocumentObject")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            is_derived_from(
                constraint_initial_temperature, "Fem::ConstraintInitialTemperature"
            )
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_plane_rotation, "Fem::ConstraintPlaneRotation")
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_self_weight, "Fem::ConstraintSectionPrint")
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_self_weight, "Fem::ConstraintSelfWeight")
        )
        ...
        self.assertTrue(
            is_derived_from(constraint_temperature, "Fem::ConstraintTemperature")
        )
        ...
        self.assertTrue(
            is_derived_from(material_nonlinear, "Fem::MaterialMechanicalNonlinear")
        )
        ...
        self.assertTrue(
            is_derived_from(equation_elasticity, "Fem::EquationElmerElasticity")
        )
        ...
        self.assertTrue(is_derived_from(equation_elasticity, "App::FeaturePython"))
        self.assertTrue(
            is_derived_from(equation_elasticity, "Fem::EquationElmerElectricforce")
        )
        ...
        self.assertTrue(
            is_derived_from(equation_electrostatic, "Fem::EquationElmerElectrostatic")
        )
    ...
    def test_femobjects_derivedfromstd(self):
        ...
        self.assertTrue(
            ObjectsFem.makeConstantVacuumPermittivity(doc).isDerivedFrom(
        ...
        self.assertTrue(
            ObjectsFem.makeConstraintFixed(doc).isDerivedFrom("Fem::ConstraintFixed")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeConstraintSpring(doc).isDerivedFrom("Fem::ConstraintSpring")
        )
        self.assertTrue(
            ObjectsFem.makeConstraintForce(doc).isDerivedFrom("Fem::ConstraintForce")
        )
        self.assertTrue(
            ObjectsFem.makeConstraintGear(doc).isDerivedFrom("Fem::ConstraintGear")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeConstraintPulley(doc).isDerivedFrom("Fem::ConstraintPulley")
        )
        self.assertTrue(
            ObjectsFem.makeConstraintSectionPrint(doc).isDerivedFrom(
                "Fem::ConstraintPython"
            )
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeConstraintTie(doc).isDerivedFrom("Fem::ConstraintPython")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeElementFluid1D(doc).isDerivedFrom("Fem::FeaturePython")
        )
        self.assertTrue(
            ObjectsFem.makeElementGeometry1D(doc).isDerivedFrom("Fem::FeaturePython")
        )
        self.assertTrue(
            ObjectsFem.makeElementGeometry2D(doc).isDerivedFrom("Fem::FeaturePython")
        )
        self.assertTrue(
            ObjectsFem.makeElementRotation1D(doc).isDerivedFrom("Fem::FeaturePython")
        )
        materialsolid = ObjectsFem.makeMaterialSolid(doc)
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeMeshBoundaryLayer(doc, mesh).isDerivedFrom(
                "Fem::FeaturePython"
            )
        )
        self.assertTrue(
            ObjectsFem.makeMeshGroup(doc, mesh).isDerivedFrom("Fem::FeaturePython")
        )
        self.assertTrue(
            ObjectsFem.makeMeshRegion(doc, mesh).isDerivedFrom("Fem::FeaturePython")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeMeshResult(doc).isDerivedFrom("Fem::FemMeshObjectPython")
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeSolverMystran(doc).isDerivedFrom(
                "Fem::FemSolverObjectPython"
            )
        )
        self.assertTrue(
            ObjectsFem.makeSolverZ88(doc).isDerivedFrom("Fem::FemSolverObjectPython")
        )
        self.assertTrue(
            ObjectsFem.makeEquationElasticity(doc, solverelmer).isDerivedFrom(
                "App::FeaturePython"
            )
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ObjectsFem.makeEquationFlow(doc, solverelmer).isDerivedFrom(
                "App::FeaturePython"
            )
        )
        self.assertTrue(
            ObjectsFem.makeEquationFlux(doc, solverelmer).isDerivedFrom(
                "App::FeaturePython"
            )
        )
        self.assertTrue(
            ObjectsFem.makeEquationHeat(doc, solverelmer).isDerivedFrom(
                "App::FeaturePython"
            )
        )
