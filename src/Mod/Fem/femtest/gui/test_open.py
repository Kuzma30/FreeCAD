...
class TestObjectOpen(unittest.TestCase):
    ...
    def test_femobjects_open_de9b3fb438(self):
        ...
        FreeCAD.closeDocument(
            self.document.Name
        )  # close the empty document from setUp first
    ...
    def compare_feature_pythons_class_gui(self, doc):
        ...
        from femviewprovider.view_constraint_bodyheatsource import (
        ...
        from femviewprovider.view_constraint_flowvelocity import (
        ...
        self.assertEqual(
            VPElementFluid1D, doc.ElementFluid1D.ViewObject.Proxy.__class__
        )
        ...
        from femviewprovider.view_material_mechanicalnonlinear import (
        ...
        self.assertEqual(
            VPMaterialReinforced, doc.MaterialReinforced.ViewObject.Proxy.__class__
        )
        ...
        self.assertEqual(
            VPMeshBoundaryLayer, doc.MeshBoundaryLayer.ViewObject.Proxy.__class__
        )
        ...
        self.assertEqual(
            VPSolverCcxTools, doc.SolverCcxTools.ViewObject.Proxy.__class__
        )
