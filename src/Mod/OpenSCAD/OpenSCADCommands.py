        ...
        def explode(obj, color=True):
            if (
                ...
                if plm.isNull() or all(
                    (
                        len(oo.InList) == 1
                        and not oo.isDerivedFrom("PartDesign::Feature")
                    )
                    ...
                    FreeCAD.Console.PrintError(
                        translate("OpenSCAD", "Unable to explode %s") % obj.Name + u"\n"
                    )
...
class ColorCodeShape:
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": QtCore.QT_TRANSLATE_NOOP(
                "OpenSCAD_ColorCodeShape", "Color Shapes"
            ),
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
...
class MirrorMeshFeature:
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
                "OpenSCAD_MirrorMeshFeature", "Create Mirror Mesh Feature"
            ),
        }
...
class ScaleMeshFeature:
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
                "OpenSCAD_ScaleMeshFeature", "Create Scale Mesh Feature"
            ),
        }
...
class ResizeMeshFeature:
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
                "OpenSCAD_ResizeMeshFeature", "Create Resize Mesh Feature"
            ),
        }
...
class ReplaceObject:
    def IsActive(self):
        ...
        if nobj == 3:
            ...
            return tuple(
                (len(obj.InList)) for obj in FreeCADGui.Selection.getSelection()
            ) in ((0, 1), (1, 0))
        # else: return False
    ...
    def Activated(self):
        ...
        if len(objs) == 3 or tuple((len(obj.InList)) for obj in objs) in (
            (0, 1),
            (1, 0),
        ):
            ...
            FreeCAD.Console.PrintError(
                translate("OpenSCAD", "Please select 3 objects first") + u"\n"
            )
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": QtCore.QT_TRANSLATE_NOOP(
                "OpenSCAD_ReplaceObject", "Replace Object"
            ),
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
...
class RemoveSubtree:
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": QtCore.QT_TRANSLATE_NOOP(
                "OpenSCAD_RemoveSubtree", "Remove Objects and their Children"
            ),
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
...
class OpenSCADMeshBoolean:
    def IsActive(self):
        return (
            ...
            and len(FreeCADGui.Selection.getSelection()) >= 1
        )
...
class Minkowski:
    ...
    def Activated(self):
        ...
        for selobj in selection:
            objList.append(selobj.Object)
            selobj.Object.ViewObject.hide()
        importCSG.process_ObjectsViaOpenSCAD(
            FreeCAD.activeDocument(), objList, "minkowski"
        )
        FreeCAD.ActiveDocument.recompute()
