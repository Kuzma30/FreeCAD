...
def likeprimitive(obj, extrusion=False):
    ...
    return (
        ...
        or extrusion
        and (
            obj.isDerivedFrom("Part::Revolution")
...
def expandplacementsmatrix(obj, matrix):
    ...
    if obj.isDerivedFrom("Part::Feature") and isinstance(obj.Proxy, MatrixTransform):
        ...
        for outobj in obj.OutList:
            if outobj.isDerivedFrom("Part::Feature") and isinstance(
                obj.Proxy, MatrixTransform
            ):
...
def expandplacements(obj, placement):
    ...
    if obj.isDerivedFrom("Part::FeaturePython") and isinstance(
        obj.Proxy, MatrixTransform
    ):
