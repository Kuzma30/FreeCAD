...
class ConsoleTestCase(unittest.TestCase):
    ...
    def testSynchronPrintFromThread(self):
        ...
        def adder():
            ...
            FreeCAD.Console.PrintMessage(
                "Call from Python thread: count=" + str(self.count) + "\n"
            )
            lock.release()
    ...
    def testAsynchronPrintFromThread(self):
        ...
        def adder():
            ...
            # call of Console method is thread-safe
            FreeCAD.Console.PrintMessage(
                "Call from Python thread (not synchronized): count="
                + str(self.count)
                + "\n"
            )
...
class ParameterTestCase(unittest.TestCase):
    ...
    def testGroup(self):
        ...
        self.assertTrue(
            self.TestPar.HasGroup("44"), "A referenced group must not be deleted"
        )
        Temp = 0
    ...
    def testFloat(self):
        ...
        self.assertEqual(
            self.TestPar.GetFloat("44"), 4711.4711, "In and out error at Float"
        )
        # check on Deletion
        self.TestPar.RemFloat("44")
        self.assertEqual(
            self.TestPar.GetFloat("44", 1.1), 1.1, "Deletion error at Float"
        )
    ...
    def testString(self):
        ...
        self.assertEqual(
            self.TestPar.GetString("44"), "abcdefgh", "In and out error at String"
        )
        # check on Deletion
